...
recibidos['BK'] = recibidos['Manual']+recibidos['Mos']+recibidos['Talla']
#Asignaciomes
...
asignaciones['BK'] = asignaciones['Manual']+asignaciones['Mos']+asignaciones['Talla']
#Merge
data = asignaciones.merge(recibidos, how='left', on=['BK'])
